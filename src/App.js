...
import WeatherFiveDays from "./FiveDays/WeatherFiveDays";
            ...
            <Sider trigger={null} collapsible collapsed={this.state.collapsed}>
              ...
              <Menu theme="dark" mode="inline" defaultSelectedKeys={["1"]}>
                ...
                <Menu.Item key="2" icon={<FundViewOutlined />}>
                  <NavLink to="/weatherfivedays">Weather for 5 days:</NavLink>
                </Menu.Item>
            ...
            <Layout className="site-layout">
              ...
              >
                ...
                <Route
                  ...
                  render={() => <WeatherFiveDays />}
                />
                <Route
                  exact
                  path="/yourweather"
                  render={() => <YourWeatherContainer />}
                />
              </Content>
            </Layout>
          </Layout>
